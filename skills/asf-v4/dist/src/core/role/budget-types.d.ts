...
export declare const BUDGET_THRESHOLDS: {
    ...
    readonly MAX_HEALTHY_EDGES: 20;
    /** Maximum healthy contract touches */
    readonly MAX_HEALTHY_CONTRACTS: 10;
};
/**
 * Determine budget status from utilization rate.
 */
export declare function getBudgetStatus(utilizationRate: number): 'healthy' | 'warning' | 'critical';
export declare function isBudgetMetrics(obj: any): obj is BudgetMetrics;
export declare function isBudgetAlert(obj: any): obj is BudgetAlert;
